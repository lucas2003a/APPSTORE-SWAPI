...
<body>
    <div class="container mt-3">
        <table class="table table-sm table-striped" id="tabla-usuarios">
            ...
            <div class="text-end">
              <a href="registrar.php" type="buttton" class="btn btn-sm btn-primary">Registrar</a>
            </div>
        </table>
    </div>
          ...
          .then(data =>{
            ...
            data.forEach(element => {
              ...
              nuevaFila = `
                ...
                <td>${numFila}</td>
                <td><a 'href='#' class='linkFoto' data-url='${element.avatar}' data-name='${element.nombres} ${element.apellidos}' data-bs-toggle="modal" data-bs-target="#modal-avatar"> Ver más </td>
                <td>${element.rol}</td>
